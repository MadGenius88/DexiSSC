    ...
    return [
      ...
      m('.blurb',
        ...
        m('p',
          ...
          'the link in the navbar above. ',
          'Once logged in, you will be ',
          'able to add new assets to ',
          'DeXIs Distributed Ledger Technology (DLT) ',
          'and track their location. ',
          'You will be able to authorize ',
          'other "users" on the DLT',
          'to track this data as well, ',
          'or even transfer ownership ',
          'or possession of the asset entirely. ',
          /* 'For the ',
