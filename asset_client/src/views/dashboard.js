  ...
  view (vnode) {
    return [
      m('.header.text-center.mb-4',
        m('h4', 'Welcome To'),
        // m('h1.mb-3.h1-color', 'DeXI'),
        m("img", { src: "../images/dexiLogo.png", style: { width: '220px', height: '150px' } }),
        m('h5',
          m('em',
            'When authenticity matters, ',
            m('strong.h1-color', 'DeXI Delivers')))),
      m('.blurb',
        /* m('p',
        ...
        m('p',
          ...
          'DeXIs Distributed Ledger Technology (DLT) and track their location. ',
          'You will be able to authorize other "users" on the ',
          'DLT to track this data as well, or even transfer ',
          'ownership or possession of the asset entirely. ',))
          /* 'For the adventurous, these actions can also be accomplished directly ',
